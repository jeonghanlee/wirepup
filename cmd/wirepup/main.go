...
var commands = []command{
	...
	{"read", "replay a capture file offline (passive)", runRead},
	{"diagnose", "rule-based diagnosis (passive)", runDiagnose},
	{"epics", "EPICS CA/PVA tools: observe, find, diagnose (find --active transmits)", runEPICS},
...
func usage(w io.Writer) {
	...
	fmt.Fprintln(w, "probe, connect, disconnect, and epics find --active are the only commands that transmit or change the host.")
}
